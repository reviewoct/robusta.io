...
class AboutSection extends React.Component {
  render() {
    return (
      <Section  >
      <div className="second withborder container">
				<div className="row">
	...
	I work with other specialized freelances, and I use specialized Saas application to build your custom applications. This ensures delivery speed, nullify the cost of servers administration, and strongly reduces the risk of security attacks.
					...
					<img className="center-block" src={nicolas} alt="" />
					
						<div className="column-6 contacts">
						<p>JAVA / Javascript  </p>
						<p><img  src={emailimg}  alt="" /> <a href="mailto:nz@robusta.io">nz@robusta.io</a> </p>
					<p><img src={smartphone}  alt="" /> +33 6 33 91 85 04 </p>
...
<div>
  ...
  <a  className="github-button" href="https://github.com/nicolas-zozol" data-style="mega"
     ...
     @nicolas-zozol</a>
  <br/>
  <a className="github-button" href="https://github.com/d-plaindoux/parsec" data-icon="octicon-star"
